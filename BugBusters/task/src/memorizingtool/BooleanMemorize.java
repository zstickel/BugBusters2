 ...
 */
public class BooleanMemorize implements AutoCloseable {
    ...
    private static final Class<?>[] ONE_BOOLEAN = {Boolean.class};
    private static final Class<?>[] ONE_INT = {int.class};
    private static final Class<?>[] TWO_INTS = {int.class, int.class};
    private static final Class<?>[] ONE_STRING = {String.class};
    private static final Class<?>[] BOOLEAN_BOOLEAN = {Boolean.class, Boolean.class};
    static final Map<String, Class<?>[]> commands = new HashMap<>();
    static {
        commands.put("/help", NO_ARGS);
        commands.put("/menu", NO_ARGS);
        commands.put("/add", ONE_BOOLEAN);
        commands.put("/remove", ONE_INT);
        commands.put("/replace", new Class<?>[]{int.class, Boolean.class}); // unique
        commands.put("/replaceAll", BOOLEAN_BOOLEAN);
        commands.put("/index", ONE_BOOLEAN);
        commands.put("/sort", ONE_STRING);
        commands.put("/frequency", NO_ARGS);
        commands.put("/print", ONE_INT);
        commands.put("/printAll", ONE_STRING);
        commands.put("/getRandom", NO_ARGS);
        commands.put("/count", ONE_BOOLEAN);
        commands.put("/size", NO_ARGS);
        commands.put("/equals", TWO_INTS);
        commands.put("/readFile", ONE_STRING);
        commands.put("/writeFile", ONE_STRING);
        commands.put("/clear", NO_ARGS);
        commands.put("/compare", TWO_INTS);
        commands.put("/mirror", NO_ARGS);
        commands.put("/unique", NO_ARGS);
        commands.put("/flip", ONE_INT);
        commands.put("/negateAll", NO_ARGS);
        commands.put("/and", TWO_INTS);
        commands.put("/or", TWO_INTS);
        commands.put("/logShift", ONE_INT);
        commands.put("/convertTo", ONE_STRING);
        commands.put("/morse", NO_ARGS);
    }
    ...
    void Run() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        while (!finished) {
                ...
                try{
                    this.getClass().getDeclaredMethod(data[0].substring(1), commands.get(data[0]));
                ...
                } catch (NoSuchMethodException |  NullPointerException | IllegalArgumentException |InvocationTargetException e) {
                    if(e instanceof  NoSuchMethodException){
                        ...
                        if(data[0].substring(1).equals("getRandom")){
    ...
    void readFile(String path) throws IOException {
        ...
        try( FileReaderBoolean readerThread = new FileReaderBoolean();) {
            List<Boolean> list2 = readerThread.read(path);
            for (Boolean i : list2) {
                list.add(i);
            }
